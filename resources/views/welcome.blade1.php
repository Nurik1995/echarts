            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="card p-3 mb-2">
                        ...
                        <div class="mt-5">
                            <div class="heading float-start">Senior Product1</div>
                            <div class="heading float-end">Senior Product2</div>
                            <div class="mt-5">
                                <div class="progress">
                ...
                <div class="col-md-3 card-body" style="display: grid">
                    <div class="card p-3 mb-2">
                        <div class="d-flex justify-content-between">
                            <div class="d-flex flex-row align-items-center">
                                <div class="icon"> <i class="bx bxl-reddit"></i> </div>
                                <div class="ms-2 c-details">
                                    <h6 class="mb-0">Reddit1</h6> <span>2 days ago</span>
                                </div>
                            </div>
                            <div class="badge"> <span>Design</span> </div>
                        </div>
                    ...
                    <div class="card p-3 mb-2 float-bottom">
                        <div class="d-flex justify-content-between">
                            <div class="d-flex flex-row align-items-center">
                                <div class="icon"> <i class="bx bxl-reddit"></i> </div>
                                <div class="ms-2 c-details">
                                    <h6 class="mb-0">Reddit2</h6> <span>2 days ago</span>
                                </div>
                            </div>
                            <div class="badge"> <span>Design</span> </div>
                        </div>
