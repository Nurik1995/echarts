<style>
    ...
    .quruyukSpotModalHead .btn-close {
        position: absolute;
        right: 1rem;
        top: 10px;
    }

    .quruyukSpotTable tfoot td {
        background: #111827;
        font-weight: bold;
...
{{-- <div class="d-flex justify-content-center">
    <button class="btn btn-primary btn-lg btn-open" data-bs-toggle="modal" data-bs-target="#quruyuk_spot">
        Spot cədvəlini aç
    </button>
</div> --}}

<!-- Modal -->
<div class="modal fade" id="quruyuk_spot" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-fullscreen modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">

            <div class="modal-header quruyukSpotModalHead">
                <h5 class="modal-title"></h5>
                <h3 class="fw-bold">
                    Spotda işləyən Quru yük gəmilərinin kommersiya göstəriciləri
                </h3>
            ...
            <div class="modal-body pt-0">
                <div class="table-responsive">
                    <table class="table table-bordered align-middle mb-0 quruyukSpotTable fw-bold">
                        <thead>
                            <tr>
