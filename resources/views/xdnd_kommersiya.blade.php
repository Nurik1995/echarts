<style>
    ...
    table.xdndKommersiyaTable1 thead th {
    ...
    /* TR – MƏCBURİ BOZ */
    table.xdndKommersiyaTable1 tbody tr {
        background-color: #7a7a7a !important;
    }

    /* TD */
    table.xdndKommersiyaTable1 tbody td {
    ...
    table.xdndKommersiyaTable1 td:first-child {
        font-weight: 600;
    }
    ...
    table.xdndKommersiyaTable2 thead th {
        background-color: #2b7da5 !important;
        color: #fff !important;
        border: 1px solid #444;
        text-align: center;
    ...
    /* TR – MƏCBURİ BOZ */
    table.xdndKommersiyaTable2 tbody tr {
        background-color: #7a7a7a !important;
    }

    /* TD */
    table.xdndKommersiyaTable2 tbody td {
        background-color: transparent !important;
        color: #fff;
        border: 1px solid #444;
        vertical-align: middle;
    ...
    table.xdndKommersiyaTable2 td:first-child {
        font-weight: 600;
    }

    .xdndKommersiyaTable2 th {
        padding: 4px 4px;
        /* DAR */
        font-size: 12px;
        /* balaca */
    ...
    .xdndKommersiyaTable1 th,
    .xdndKommersiyaTable1 td {
        padding: 4px 3px !important;
        font-size: 12px;
        line-height: 1.1;
        white-space: normal !important;
...
<div class="modal fade" id="xdnd_kommersiya" tabindex="-1">
        ...
        <div class="modal-content dashboard-modal">
            ...
            <div class="modal-header border-0">
                <h5 class="modal-title text-white fw-bold">
                    XDND gəmilərinin kommersiya göstəriciləri
                </h5>
            ...
            <div class="modal-body">
                ...
                <!-- TAYM CHARTER -->
                <div class="card dashboard-card mb-4" data-bs-toggle="modal" data-bs-target="#xdnd_taymcarter_table">
                    ...
                    <div class="card-body">
                        <div class="row g-4">
                            ...
                            <div class="col-12 col-lg-5">
                                ...
                                <table class="table xdndKommersiyaTable1 table-sm text-center align-middle">
                                    <thead>
                                        <tr>
                            ...
                            <div class="col-lg-7 col-12 chart-col">
                                ...
                                <div id="xdndTimeCharter" class="chart-div chart-box"></div>
                                ...
                                <br>
                                <table
                                    class="table table-responsive xdndKommersiyaTable2 table-sm text-center align-middle">
                                    <thead>
                                        <tr>
                                            <th>Müştərinin adı</th>
                                            <th>Plan gəlir</th>
...
<script>
    // xdnd TIMECHARTER
    var dom = document.getElementById('xdndTimeCharter');
    var xdndTimeCharter = echarts.init(dom);
    var app = {};
    ...
    if (option && typeof option === 'object') {
        xdndTimeCharter.setOption(option);
    }

    var modalEl = document.getElementById('xdnd_kommersiya');

    modalEl.addEventListener('shown.bs.modal', function() {
        if (!xdndTimeCharter) {
            xdndTimeCharter = echarts.init(document.getElementById('xdndTimeCharter'));
            xdndTimeCharter.setOption(option);
        } else {
            xdndTimeCharter.resize();
        }
    });
